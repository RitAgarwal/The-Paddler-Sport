...
include_once '../config.php';
 ...
 <div class="container">
       ...
       <h1 class="h1">The Paddle Sport</h1>
       <div class="button">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="" action="" method="post">
          ...
          <div class="form-group">
            <button type="button" id="login" name="submit" value="Login" class="btn btn-success" style="width: 100%;background: linear-gradient(to right, #000066 0%, #3366ff 100%);">Login</button>
          </div>
        </form>
      </div>
